    ...
    return (
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-md border border-gray-100 text-center">
            ...
            <div className="space-y-3">
                <Link href="/" className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-xl transition-colors">
                    กลับไปหน้าหลัก
                </Link>
                <div>
                    <Link href="/order/history" className="text-purple-600 hover:text-purple-700 font-medium text-sm" >
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-50">
            ...
            <main className="pt-20 sm:pt-24 pb-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                <Suspense fallback={<div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-md border border-gray-100 text-center">กำลังโหลด...</div>}>
                    <SuccessContent />
                </Suspense>
            </main>
        </div>
